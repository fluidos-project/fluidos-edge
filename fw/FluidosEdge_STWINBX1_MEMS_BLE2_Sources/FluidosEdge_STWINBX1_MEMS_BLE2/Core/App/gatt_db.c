...
#define COPY_CONFIG_CHAR_UUID(uuid_struct)             COPY_UUID_128(uuid_struct,0x00,0xF0,0x00,0x00,0x00,0x01,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b)
...
/* Private variables ---------------------------------------------------------*/
uint16_t HWServW2STHandle, EnvironmentalCharHandle, AccGyroMagCharHandle, ConfigCharHandle;
...
tBleStatus Add_HWServW2ST_Service(void)
{
  ...
  /* Fill the Configuration (Write) BLE Characteristc */
  COPY_CONFIG_CHAR_UUID(uuid);
  BLUENRG_memcpy(&char_uuid.Char_UUID_128, uuid, 16);
  ret =  aci_gatt_add_char(HWServW2STHandle, UUID_TYPE_128, &char_uuid,
                           6,
			   CHAR_PROP_WRITE,
