...
#ifndef USE_CUSTOM_ENV_SENSOR_ILPS22QS_0
#define USE_CUSTOM_ENV_SENSOR_ILPS22QS_0        1
#endif
...
#define CUSTOM_ENV_INSTANCES_NBR    (USE_CUSTOM_ENV_SENSOR_ILPS22QS_0)
